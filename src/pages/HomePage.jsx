...
function HomePage() {
  ...
  useEffect( () => {
    loadInfo(`https://geo.ipify.org/api/v2/country,city?apiKey=${process.env.REACT_APP_IPIFY_API_KEY}`);
  },[]);
  ...
  return (
    <div className="bg-gray-300 h-screen flex flex-col justify-center items-center">
      ...
      {/* content box */}
      <div className="flex flex-col justify-between h-full w-full shadow-2xl ipat-max-width md:w-5/6 md:h-5/6 ">

        {/* Banner */}
        <div className="ipat-banner relative flex flex-col justify-start items-center">
          <h1 className="text-3xl text-white font-bold mt-8">IP Address Tracker</h1>
          ...
          <div className="mt-6 flex">
            <input 
              ...
              ref={inputRef}
            />
            <button onClick={handleInput} className="flex justify-center items-center w-12 bg-black rounded-r-lg hover:opacity-70">
          ...
          <div className="w-96 md:w-11/12 md:max-w-5xl p-6 absolute flex flex-col justify-center items-center space-y-4 bg-white rounded-lg bottom-0 left-1/2 translate-y-1/2 -translate-x-1/2 z-10 shadow-xl md:flex-row md:space-y-0 md:space-x-8 md:divide-x md:divide-gray-300">
            ...
            <div className="text-center md:text-left">
              <p className="uppercase text-DarkGray text-xs font-bold tracking-widest">IP Address</p>
              {/* <h3 className=" text-VeryDarkGray font-medium mt-1">{ip}</h3> */}
              <h3 className=" text-VeryDarkGray font-medium mt-1">{ip?ip:'----------'}</h3>
            </div>

            <div className="pl-3 text-center md:text-left">
              <p className="uppercase text-DarkGray text-xs font-bold tracking-widest">Location</p>
              {/* <h3 className=" text-VeryDarkGray font-medium mt-1">{`${city}, ${region}, ${country}`}</h3> */}
              <h3 className=" text-VeryDarkGray font-medium mt-1">{`${city?city:'----------'}, ${region?region:''}, ${country?country:''}`}</h3>
            </div>

            <div className="pl-3 text-center md:text-left">
              <p className="uppercase text-DarkGray text-xs font-bold tracking-widest">Timezone</p>
              {/* <h3 className=" text-VeryDarkGray font-medium mt-1">{`UTC ${timezone}`}</h3> */}
              <h3 className=" text-VeryDarkGray font-medium mt-1">{`UTC ${timezone? timezone:'----------'}`}</h3>
            </div>

            <div className="pl-3 text-center md:text-left">
              <p className="uppercase text-DarkGray text-xs font-bold tracking-widest">ISP</p>
              {/* <h3 className=" text-VeryDarkGray font-medium mt-1">{isp}</h3> */}
              <h3 className=" text-VeryDarkGray font-medium mt-1">{isp?isp:'----------'}</h3>
            </div>
